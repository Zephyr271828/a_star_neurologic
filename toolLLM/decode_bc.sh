...
DEVICES=0
OUTPUT_FILE=output_decode/result_bc.txt
...
CUDA_VISIBLE_DEVICES=${DEVICES} python decode_bc.py --model_name ${MODEL_RECOVER_PATH} \
  ...
  --batch_size 1 --beam_size 4 --max_tgt_length 150 \

...
def generate(
    ...
    **model_specific_kwargs
    ...
    # otherwise the parameters in the model configuration
    ...
    # check the data type and range of the parameters
...
def calc_banned_ngram_tokens(prev_input_ids: Tensor, num_hypos: int, no_repeat_ngram_size: int, pad_token_id: int) -> None:
    ...
    for idx in range(num_hypos):
        ...
        # this line of code iterates over all n-grams in the sequence
